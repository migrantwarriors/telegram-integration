module.exports = Object.freeze({
    ...
    MULTIOTHERSSKILL: 'कृपया अपना कौशल प्रदान करें। यदि एकाधिक, तो उन्हें अलग से अल्पविराम प्रदान करें। अधिकतम 3 की अनुमति है।',
    ...
    PINCODEERRORMSG: '\n<b>1पिनकोड</b> अमान्य है। यह 6 अंकों का होना चाहिए और सभी संख्या होनी चाहिए।',
    ADDRESSERRORMSG: '\n<b>1पता</b> अमान्य है। इसमें - और / के अलावा अन्य विशेष वर्ण शामिल नहीं होने चाहिए।',
    EMPTYSTRING: '',
    COMMASTRING: ',',
    ...
    SKILLKEYBOARDARRAY:[
                ["मल्टी-स्किल/अन्य", "मेसन", "प्लम्बर", "ड्राइवर"],
